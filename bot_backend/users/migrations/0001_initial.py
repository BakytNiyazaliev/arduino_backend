    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('Master', 'Master'), ('Staff', 'Staff'), ('Customer', 'Customer')], default='Customer', max_length=10)),
                ('rfid', models.CharField(max_length=40, unique=True)),
